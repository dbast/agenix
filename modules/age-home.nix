  ...
  options.age = {
    ...
    identityPaths = mkOption {
      ...
      description = ''
        ...
        Also supports age identity files (e.g., ~/.config/age/*.key generated with age-keygen or age-keygen -pq for post-quantum keys).
        For module-based decryption, add all key paths explicitly in this option.
      '';
    };
